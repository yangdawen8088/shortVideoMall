...
.main .video-view .goods .title{
	color: white;
	font-size: 36upx;
}
.main .video-view .goods .payinfo{
	margin-top: 17upx;
}
.main .video-view .goods .seller{
	color: gray;
	font-size: 24upx;
	margin-top: 6upx;
}
.main .video-view .goods .payinfo .currency{
	color: white;
	font-size: 24upx;
}
.main .video-view .goods .payinfo .price{
	color: white;
	font-size: 40upx;
}
.main .video-view .goods .payinfo .payernum{
	color: gray;
	font-size: 24upx;
	margin-left: 20upx;
}
.main .video-view .goods .action{
	padding-top: 40upx;
}
.main .video-view .goods .action image{
	width: 60upx;
	height: 60upx;
}
.main .video-view .goods .action .share{
	margin-right: 20upx;
	text-align: center;
	color: gray;
}
.main .video-view .goods .action .favor{
	margin-right: 20upx;
	text-align: center;
	color: gray;
}
.main .video-view .goods .action button{
	background-color: #b79846;
}

.main .video-view .goods .user .head-img{
	border-radius: 50upx;
	width: 60upx;
	height: 60upx;
}
.main .video-view .goods .user .nickname{
	color: gray;
	font-size: 24upx;
	margin-left: 20upx;
}
.main .video-view .goods .location{
...
.main .video-view .goods .location .location-icon{
	font-size: 22upx;
}
.main .video-view .goods .location .location_name{
	
}
.main .video-view .goods .desc{
	margin-top: 20upx;
	font-size: 24upx;
	color: gray;
}
